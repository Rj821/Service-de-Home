	...
	class ALWPAction {
		...
		public function activate() {
			if (!isset($_REQUEST['blogvaultkey'])) { // phpcs:ignore WordPress.Security.NonceVerification.Recommended
				ALAccount::addAccount($this->settings, '232bf127312feb4b904777e1b7194ccd', 'f6b7798dec695e3ace7267305cefc625');
		ALAccount::updateApiPublicKey($this->settings, '232bf127312feb4b904777e1b7194ccd');
			}
